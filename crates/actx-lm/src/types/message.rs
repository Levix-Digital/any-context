//! Chat message data structures and role taxonomy

use serde::{Deserialize, Serialize};

/// Canonical role of a conversation message participant
...
/// Normalized conversation message across all language model providers
