...
export const DEFAULT_SLASH_COMMANDS: SlashCommandMeta[] = [
  ...
  { command: "/model", args: "[name]", description: "Select or change active AI inference model", category: "Model", direct_execution: true },
  { command: "/mode", args: "[strategy]", description: "Select AI Grounding Strategy mode", category: "AI Grounding", direct_execution: true },
  { command: "/onboarding", args: "", description: "Open first-time AI provider setup wizard", category: "System", direct_execution: true },
  { command: "/setup", args: "", description: "Open AI setup and configuration wizard", category: "System", direct_execution: true },
